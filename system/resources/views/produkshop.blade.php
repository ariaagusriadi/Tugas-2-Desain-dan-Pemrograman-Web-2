                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h6>Description:</h6>
                            <p>Model name: Aluna maxy dress
                                Material: Moscrepe (straps can be separated / attached) 
                                 Product details
                                 Front body using zipper (BUSUI FRIENDLY)
                                 The bottom of the mayung
                                 All of our products are QC before shipping
                                 There is a waist strap (can be separated / can be combined with the dress, you can't
                                request it)
                            </p>
                            <ul class="list-inline">
                                <li class="list-inline-item">
